...
function App() {
  ...
  function WellcomeMessageCard () {
    return (
      ...
      <Card>
        <Heading level={3}>こんにちは！<br/><br/>あなたの「出身地」,「学生時代の部活」,「趣味」,「好きな映画・ドラマ」,「好きな料理ジャンル」,「休日の過ごし方」,「大学の学部」等を入力してみてください。<br/>相性の良い人をレコメンドします。</Heading>

        <Heading level={4}><br/>部署は公共事業部、出身地は東京、学生時代の部活はテニス部、趣味はサッカー観戦、好きな映画はクリストファー・ノーラン作品、好きな料理はラーメン、休日は子どもと遊ぶ、大学時代は商学部、です。相性の良い人をレコメンドして。</Heading>
      </Card>
